...
-   **Writing**
    -   Keep applying for internal/external fellowships and funding opportunities (it would be excellent practice for scientific writing and critical thinking; it recognizes your ideas and trajectory; it would also be amazing to receive funding to pursue new independent research projects that even slightly divergent from the PI's projects).
    -   Contribute proactively to grant proposal writing with the PI by proposing new ideas and generating preliminary results.
-   **Scientific communication**
    ...
    -   Look out for opportunities that PI/others often post in the lab Slack, the RIO/CU Bioinfo Slack workspaces, or email. These opportunities to look out for are but are not limited to, funding, poster events, presentations, conferences, seminars, and courses.
    -   Submit abstracts to several conferences; ideally, all regional meetings that the whole group would attend (e.g., Rocky Mountain Branch of ASM, Rocky Bioinformatics, Frontrange Microbiome, qCMB at CSU), at least one national meeting (2+ years/post-comps grads are encouraged to submit talk abstracts and more junior (pre-comps/rotation) students can submit posters if they have in-progress or shorter stories to communicate. All students are encouraged to apply for travel and conference fellowships from CU, national societies, and the meetings themselves.
...
-   **Project/time management**
    ...
    -   **Deadlines.** Establish clear deadlines/academic plans, e.g., comprehensive exam, defense. Plan to graduate well within 5 years, especially if you are ready in terms of progress, manuscripts, conferences, and other milestones; finish your comprehensive exam by the start of your third year (end-of-second-year would be preferable and ideal to keep you on track).
...
-   **Semester planning.** In addition to detailed research goals, set SMART goals for professional and personal development. Below is a general list of what semester planning entails.
    ...
    -   Attend seminars (regularly/weekly; look beyond your compulsory grad program series alone) and conferences.
...
-   **Communication.** Communicating science is a fundamental and essential part of this role, be it through manuscripts, conference presentations, or workshops. Expect to keep busy presenting your work at regional and (inter)national platforms, and use the experience to get your name out there and network! Once you've found your footing, we encourage postdocs to always apply for talks (alongside posters).
...
-   In addition to the most applicable points from the `Graduate Student` section above (barring rare exceptions like comprehensive exams, etc.), the following are great pointers for research professionals.
...
A part of this is also highlighted above in `Mission`, `Mentoring philosophy`, `Inclusive lab climate`, and `Code of Conduct`. In addition, the University of Colorado offers training in diversity, equity, and inclusion topics, including the [Health Equity in Action Lab (HEAL)](https://www.cuanschutz.edu/offices/access-engagement/programs-and-initiatives/heal-trainings-and-workshops#ac-foundations-in-equity-certificate-program-0). We encourage you to participate in these trainings, including the [Foundations in Equity Certificate Program](https://www.cuanschutz.edu/offices/access-engagement/programs-and-initiatives/heal-trainings-and-workshops/equity-certificate-program).

While not required by CU, these modules will introduce you to a great range of perspectives, explain topics like implicit bias or microaggressions, and how to recognize and interrupt them in ourselves and others and treat others more equitably and respectfully. Beyond the obvious benefits to our lab culture, these topics are absolutely critical to recognize for scientific study design (e.g. using human data). Being aware of our implicit biases and systemic issues can help navigate potential pitfalls in data collection and interpretation, which can affect people worldwide.
...
[Presenteeism](https://pubmed.ncbi.nlm.nih.gov/15559575/) isn't a healthy mindset, and health and productivity rank ahead (in that order!) of simply being present. Similarly, preferring not to be at work might also be indicative of potential issues. Talk to your mentor(s) and labmates, in case you have any concerns regarding working in person.
...
-   It's understandable that things occasionally come up -- so it's for a few hours/day(s); feel free to drop me (PI) a quick note and take off as needed.

-   If it's more than 1-3 days (or recurring hours/days), let me (PI) know in advance so we can plan ahead.

-   If it's \>3 days, please include me (PI) in the conversation during the planning phase (before booking your tickets/planning your travel). It's better for all parties involved if this is a conversation rather than an FYI. \*Similar for \>few days of remote work, unless previously requested.
...
-   Because our group is tightly collaborative, please plan non-sick leave ahead of time to best fit all schedules when possible -- at least check in with your mentor(s), mentee(s), and closest collaborators in advance.
-   For graduate students: Details may vary per your specific graduate program's handbook, but [the Graduate School offers basic guidelines herefor vacation and leave](https://www.ucdenver.edu/docs/librariesprovider138/denver-anschutz-graduate-school/resources/gs-student-leavevacpolicy.pdf?sfvrsn=661c22b9_2).
